...
The reference genome is assembled from transcriptomes of P. nobilis and P. rudis, composed of highly accurate short reads obtained from the NCBI SRA database (see the [Selected transcriptomes]([Selected transcriptomes](https://github.com/Alban-ren/Wiki-Nacre/blob/362485f1a134c004728a4a5ad1abe421f549dcf3/Selected%20transcriptomes) section). These transcriptomes are presumed to be free from H. pinnae contamination.
