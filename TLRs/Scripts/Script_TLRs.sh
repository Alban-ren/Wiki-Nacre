...
BRAKER_GFF="braker3/augustus.hints.gff"      # BRAKER3 annotation file (GFF format)
...
# 2 - MAP PROTEIN IDs TO TRANSCRIPT IDs USING GFF
# ============================
echo "Mapping protein IDs to transcript IDs using BRAKER3 GFF..."
TLR_TRANSCRIPT_IDS="TLR_transcript_IDs.txt"
grep -Ff "$OUTPUT_IDS" "$BRAKER_GFF" | grep 'transcript_id' | \
